      ...
      <div className="row mt-5">
        <div className="col">
          <img
            ...
            style={{ width: "45%" }}
          />
          <p className="text-muted" > &copy; 2010-2026, Not Zerodha Broking
             ltd.  <br/> All rights reserved</p>
             <hr/>
             <a href=""> <img src="media/images/googlePlayBadge.svg" alt=" Google play" 
              style={{width:"40%"}}
             /> </a>
             <a href=""> <img src="media/images/appstoreBadge.svg" alt=" Google play" 
              style={{width:"40%", marginLeft:"1rem"}}
             /> </a>
        </div>
        <div className="col ankers mb-3" >
          <h4>Company</h4>
